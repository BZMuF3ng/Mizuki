...
export const siteConfig: SiteConfig = {
	title: "白之沐风的博客",
	subtitle: "BZMuF3ng's blog",
	siteURL: "https://bzmuf3ng.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-12-19", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "965069", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "这里是白之沐风 aka BZMuF3ng的个人博客。", // 公告内容
